...
def main():
    ...
    for name in fname:
        ...
        feature_name2 = ['Medu','Fedu','failures', 'age','traveltime','sex','address','Mjob','reason','internet','higher','G3']
        ...
        for i in range(10):
            ...
            # f1, p, r, _ = test_SVM(train_data, train_label, test_data, test_label, "rbf", C, gamma)
